...
public class Studiejaar1 extends Fragment {
    ...
    public View onCreateView(
        ...
        View rootView = inflater.inflate(R.layout.fragment_studiejaar1, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById((R.id.back)).setOnClickListener(view1 ->
                NavHostFragment.findNavController(Studiejaar1.this)
                        .navigate(R.id.action_studiejaar1_to_studiejaarFragment));
    }
