...
public class Studiejaar3 extends Fragment {
    ...
    public View onCreateView(
        ...
        View rootView = inflater.inflate(R.layout.fragment_studiejaar3, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById((R.id.back)).setOnClickListener(view1 ->
                NavHostFragment.findNavController(Studiejaar3.this)
                        .navigate(R.id.action_studiejaar3_to_studiejaarFragment));
    }
